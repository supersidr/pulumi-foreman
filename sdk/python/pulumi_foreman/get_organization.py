...
def get_organization(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('foreman:index/getOrganization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
...
def get_organization_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('foreman:index/getOrganization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult)
